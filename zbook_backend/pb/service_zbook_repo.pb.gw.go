...
func request_ZBookRepo_GetRepoLayout_0(ctx context.Context, marshaler runtime.Marshaler, client ZBookRepoClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq rpcs.GetRepoLayoutRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetRepoLayout(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ZBookRepo_GetRepoLayout_0(ctx context.Context, marshaler runtime.Marshaler, server ZBookRepoServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq rpcs.GetRepoLayoutRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetRepoLayout(ctx, &protoReq)
	return msg, metadata, err

}

func request_ZBookRepo_MarkRepoAsDeleted_0(ctx context.Context, marshaler runtime.Marshaler, client ZBookRepoClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq rpcs.MarkRepoAsDeletedRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.MarkRepoAsDeleted(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ZBookRepo_MarkRepoAsDeleted_0(ctx context.Context, marshaler runtime.Marshaler, server ZBookRepoServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq rpcs.MarkRepoAsDeletedRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.MarkRepoAsDeleted(ctx, &protoReq)
	return msg, metadata, err
...
func request_ZBookRepo_GetRepoID_0(ctx context.Context, marshaler runtime.Marshaler, client ZBookRepoClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq rpcs.GetRepoIDRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetRepoID(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ZBookRepo_GetRepoID_0(ctx context.Context, marshaler runtime.Marshaler, server ZBookRepoServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq rpcs.GetRepoIDRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetRepoID(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterZBookRepoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ZBookRepoServer) error {
	...
	mux.Handle("POST", pattern_ZBookRepo_GetRepoLayout_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.ZBookRepo/GetRepoLayout", runtime.WithHTTPPathPattern("/v1/get_repo_layout"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ZBookRepo_GetRepoLayout_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ZBookRepo_GetRepoLayout_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ZBookRepo_MarkRepoAsDeleted_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.ZBookRepo/MarkRepoAsDeleted", runtime.WithHTTPPathPattern("/v1/delete_repo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ZBookRepo_MarkRepoAsDeleted_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ZBookRepo_MarkRepoAsDeleted_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ZBookRepo_GetRepoID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.ZBookRepo/GetRepoID", runtime.WithHTTPPathPattern("/v1/get_repo_id"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ZBookRepo_GetRepoID_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ZBookRepo_GetRepoID_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterZBookRepoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ZBookRepoClient) error {
	...
	mux.Handle("POST", pattern_ZBookRepo_GetRepoLayout_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.ZBookRepo/GetRepoLayout", runtime.WithHTTPPathPattern("/v1/get_repo_layout"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ZBookRepo_GetRepoLayout_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ZBookRepo_MarkRepoAsDeleted_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.ZBookRepo/MarkRepoAsDeleted", runtime.WithHTTPPathPattern("/v1/delete_repo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ZBookRepo_MarkRepoAsDeleted_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ZBookRepo_GetRepoID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.ZBookRepo/GetRepoID", runtime.WithHTTPPathPattern("/v1/get_repo_id"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ZBookRepo_GetRepoID_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ZBookRepo_GetRepoLayout_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "get_repo_layout"}, ""))

	pattern_ZBookRepo_MarkRepoAsDeleted_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "delete_repo"}, ""))
	...
	pattern_ZBookRepo_GetRepoID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "get_repo_id"}, ""))
)

var (
	forward_ZBookRepo_CreateRepo_0 = runtime.ForwardResponseMessage

	forward_ZBookRepo_GetRepoLayout_0 = runtime.ForwardResponseMessage

	forward_ZBookRepo_MarkRepoAsDeleted_0 = runtime.ForwardResponseMessage
	...
	forward_ZBookRepo_GetRepoID_0 = runtime.ForwardResponseMessage
)
