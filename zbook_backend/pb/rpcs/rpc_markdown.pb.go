...
var file_rpcs_rpc_markdown_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_rpcs_rpc_markdown_proto_goTypes = []interface{}{
	...
	(*models.Markdown)(nil),            // 8: pb.Markdown
}
var file_rpcs_rpc_markdown_proto_depIdxs = []int32{
	8, // 0: pb.GetMarkdownContentResponse.markdown:type_name -> pb.Markdown
	8, // 1: pb.QueryRepoMarkdownResponse.elements:type_name -> pb.Markdown
	8, // 2: pb.QueryUserMarkdownResponse.elements:type_name -> pb.Markdown
