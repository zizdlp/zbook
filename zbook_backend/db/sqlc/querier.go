...
type Querier interface {
	...
	GetDailyActiveUserCount(ctx context.Context, timezone string) ([]GetDailyActiveUserCountRow, error)
	GetDailyCreateUserCount(ctx context.Context, timezone string) ([]GetDailyCreateUserCountRow, error)
