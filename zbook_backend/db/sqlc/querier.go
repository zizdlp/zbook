...
type Querier interface {
	...
	GetListActiveSessionCount(ctx context.Context) (int64, error)
	...
	GetListUserCount(ctx context.Context) (int64, error)
	...
	GetQueryActiveSessionCount(ctx context.Context, query string) (int64, error)
	...
	GetQueryUserCount(ctx context.Context, query string) (int64, error)
	...
	GetRepoBasicInfo(ctx context.Context, repoID int64) (GetRepoBasicInfoRow, error)
	...
	ListActiveSession(ctx context.Context, arg ListActiveSessionParams) ([]ListActiveSessionRow, error)
	...
	ListRepoVisibilityByRepo(ctx context.Context, arg ListRepoVisibilityByRepoParams) ([]User, error)
	...
	QueryActiveSession(ctx context.Context, arg QueryActiveSessionParams) ([]QueryActiveSessionRow, error)
