...
export default function CodeBlock({
  ...
  return (
    <div className="relative z-10 my-[1.25em] col-span-3 font-base rounded-md dark:bg-slate-800/50 dark:ring-1 ring-slate-200/50 dark:ring-slate-900/10 border-[0.01rem] border-slate-300 dark:border-0">
      ...
      <div className="highlight p-2 md:px-4 md:py-2 text-xs md:text-sm text-slate-800 dark:text-slate-200 scrollbar-thin scrollbar-thumb-rounded-md scrollbar-track-rounded-md overflow-auto max-h-[42rem]">
        {lang === "mermaid" ? (
